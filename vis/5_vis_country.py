...
try:
   ...
   try:
       os.chdir("/mnt/eqvl2/sh2264/vision/code/")
   except:
       try:
           os.chdir("/Users/shengli/Dropbox/AAA/logos/code/")
       except:
           try:
               os.chdir("/Users/sheng/Dropbox/AAA/logos/code/")
...
cpath = os.getcwd()
os.chdir("./tensorflow/models/tutorials/image/imagenet/deep-learning-models/")
print("system argument 1: number of training epochs for memorability score")
print("system argument 5: number of training epochs for likability score")
...
from keras.layers import Flatten
#from keras.layers import Merge does not work any more
...
def add_new_last_continuous_layer(base_model):
  ...
  predictions = Lambda(euclidean_distance, output_shape=eucl_dist_output_shape)([x1, x2])
...
model0.save(sys.argv[1]+"_"+sys.argv[5]+"_"+sys.argv[2]+"_"+sys.argv[3]+"_"+sys.argv[4]+".model")
...
history_pop = model_pop.fit(train_x, train_y_pop, validation_data = (test_x, test_y_pop), nb_epoch=epochs_l, batch_size=32)
...
np.save("features_model_mem_"+sys.argv[2]+"_"+sys.argv[1]+"_"+sys.argv[5]+"_"+sys.argv[3]+"_"+sys.argv[4]+".npy",features_mem)
np.save("scores_model_mem_"+sys.argv[2]+"_"+sys.argv[1]+"_"+sys.argv[5]+"_"+sys.argv[3]+"_"+sys.argv[4]+".npy",scores_mem)
print(dir(model_mem))
#pickle.dump(history_mem, open('history_model_mem_'+sys.argv[2]+'_'+sys.argv[1]+"_"+sys.argv[5]+"_"+sys.argv[3]+"_"+sys.argv[4]+'.pkl','wb'))
#pickle.dump(model_mem, open('model_mem_'+sys.argv[2]+'_'+sys.argv[1]+"_"+sys.argv[5]+"_"+sys.argv[3]+"_"+sys.argv[4]+'.pkl','wb'))
#plot(model_mem, to_file='model_mem_'+sys.argv[2]+'_'+sys.argv[1]+"_"+sys.argv[5]+"_"+sys.argv[3]+"_"+sys.argv[4]+'.png')

np.save("features_model_pop_"+sys.argv[2]+"_"+sys.argv[1]+"_"+sys.argv[5]+"_"+sys.argv[3]+"_"+sys.argv[4]+".npy",features_pop)
np.save("scores_model_pop_"+sys.argv[2]+"_"+sys.argv[1]+"_"+sys.argv[5]+"_"+sys.argv[3]+"_"+sys.argv[4]+".npy",scores_pop)
print(dir(model_pop))
#pickle.dump(history_pop, open('history_model_pop_'+sys.argv[2]+'_'+sys.argv[1]+"_"+sys.argv[5]+"_"+sys.argv[3]+"_"+sys.argv[4]+'.pkl','wb'))
#pickle.dump(model_pop, open('model_pop_'+sys.argv[2]+'_'+sys.argv[1]+"_"+sys.argv[5]+"_"+sys.argv[3]+"_"+sys.argv[4]+'.pkl','wb'))
#plot(model_pop, to_file='model_pop_'+sys.argv[2]+'_'+sys.argv[1]+"_"+sys.argv[5]+"_"+sys.argv[3]+"_"+sys.argv[4]+'.png')
